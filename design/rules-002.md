# Matryoshka Zig — Rules (002)

Versioned doc. Replaces [rules-001.md](rules-001.md).
All coding, doc, and process rules for the project.
Companion: [matryoshka-model-002.md](matryoshka-model-002.md) — the thinking model.
